...
public class Assignment5c
{
   ...
   public static void main(String[] args)
   {
      ...
      CardGameFramework highCardGame = new CardGameFramework(numPacksPerDeck, numJokersPerPack, numUnusedCardsPerPack, unusedCardsPerPack, PLAYERS, CARDS_PER_HAND);
     ...
     //attaches pictures to play area of the table
     ...
     //    playedCardLabels[count] = new JLabel(GUICard.getIcon(generateRandomCard()));
      ...
      //for(count=0; count<PLAYERS; count++)
      //   myCardTable.pnlPlayArea.add(playedCardLabels[count]);
      ...
      //action event for button 1 (far left)
      humanLabels[0].addActionListener(new ActionListener() {
        public void actionPerformed(ActionEvent e) {
           highCardGame.playCard(0, 0);
        }
      });
      
      //action event for button 2
      humanLabels[1].addActionListener(new ActionListener() {
        public void actionPerformed(ActionEvent e) {
